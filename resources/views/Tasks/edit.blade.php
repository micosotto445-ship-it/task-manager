        ...
        <form action="{{ route('tasks.update', $task->id) }}" method="POST">
            ...
            <div class="field">
                ...
                <div class="status-toggle">
                    <input type="radio" id="status_pending" name="status" value="Pending" {{ $task->status == 'Pending' ? 'checked' : '' }}>
                    <label class="opt" for="status_pending">Pending</label>
                    <input type="radio" id="status_completed" name="status" value="Completed" {{ $task->status == 'Completed' ? 'checked' : '' }}>
